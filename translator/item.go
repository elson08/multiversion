...
import (
	...
	"github.com/potlounge/multiversion/internal/item"
...
func (t *DefaultItemTranslator) UpgradeItemType(input protocol.ItemType) protocol.ItemType {
	...
	itemName, _ := t.mapping.ItemRuntimeIDToName(input.NetworkID)
	networkID, _ = t.latest.ItemNameToRuntimeID(itemName)
